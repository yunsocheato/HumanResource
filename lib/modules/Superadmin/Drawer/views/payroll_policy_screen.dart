                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: TextFormField(
                        ...
                        validator: (value) => (value == null || value.trim().isEmpty)
                            ? 'Please Set Salary'
                            : null,
                        onSaved: (value) => controller.SetSalary.value =
                      ...
                      children: [
                        Expanded(
                          child: CheckboxListTile(
                            ...
                            title: const Text('User Cannot Change \n Salary without Admin'),
                        ...
                        Expanded(
                          child: CheckboxListTile(
                            contentPadding: EdgeInsets.zero,
                            title: const Text('User Can Change \n Salary their own'),
                    ...
                    Padding(
                      padding: const EdgeInsets.symmetric(vertical: 8.0),
                      child: TextFormField(
                        initialValue: controller.IncreaseSalary.toString(),
                        keyboardType: TextInputType.number,
                        decoration: InputDecoration(
                        ...
                        onSaved: (value) => controller.IncreaseSalary.value =
                            double.tryParse(value ?? '') ?? 0,
                      ),
                    ),
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          labelText: 'Set Salary',
                          suffixIcon: Icon(Icons.monetization_on, color: Colors.purple.shade900),
                          border: const OutlineInputBorder(),
                        ),
                        validator: (value) => (value == null || value.trim().isEmpty)
                            ? 'Please Set Salary'
                    ...
                    Row(
                      children: [
                        Expanded(
                          child: CheckboxListTile(
                            title: const Text('Restrict',style: TextStyle(fontSize: 15),),
                            value: controller.usercannotchange.value,
                            onChanged: (value) =>
                            controller.usercannotchange.value = value ?? false,
                          ),
                        ...
                        Expanded(
                          child: CheckboxListTile(
                            title: const Text(' Unrestrict',style: TextStyle(fontSize: 15),),
                            value: controller.usercanchange.value,
                            onChanged: (value) =>
                            controller.usercanchange.value = value ?? false,
                          ),
