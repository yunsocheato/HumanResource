...
import 'package:hrms/modules/Department/widgets/department_annoucnce_widget.dart';
      ...
      return Obx(() {
        ...
        return Theme(
          ...
          child: ExpansionTile(
            ...
            leading: Icon(EneftyIcons.buildings_2_bold,
              size: iconSize,
              color: controller.selectedIndex.value == 17 ? Colors.blue.shade900
                  : Colors.white,),
            title: InkWell(
              onTap: () {
              ...
              child: Text(
                ...
                style: TextStyle(
                  ...
                  color: controller.selectedIndex.value == 17 ? Colors.blue.shade900
                      : Colors.white,
                  fontWeight:  controller.selectedIndex.value == 17
                      ? FontWeight.bold
                      : FontWeight.normal,
                ),
              ),
