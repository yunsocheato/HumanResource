                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 5),
                      Text('StartDate: ${record.start_date.toString()}'),
                      const SizedBox(height: 5),
                      Text('StartTimes: ${record.time_start.toString()}'),
                      const SizedBox(height: 5),
                      Text('EndDate: ${record.end_date.toString()}'),
                      const SizedBox(height: 5),
                      Text('EndTimes: ${record.end_time.toString()}'),
                      const SizedBox(height: 5),
                      Row(
                        children: [
                          ...
                          Text(
                            'on date ${controller.formatDateTime(record.created_at)}',
                          ),
                        ],
                      ),
                    ],
