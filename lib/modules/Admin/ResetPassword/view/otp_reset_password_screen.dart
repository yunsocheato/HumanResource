...
class OTPResetPasswordScreen extends GetView<ResetPasswordController> {
  OTPResetPasswordScreen({super.key});

  static const String routeName = '/otp_reset';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        leading: IconButton(
          onPressed: () {
            Get.offAllNamed('/email_verify_reset');
          },
  ...
  Widget _buildOtpContent(ResetPasswordController c) {
    return Column(
