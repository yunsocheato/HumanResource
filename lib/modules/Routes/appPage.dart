...
import '../../SplashScreen/widget/splash_view.dart';
...
class AppPages {
  static final pages = [
    ...
    GetPage(name: AppRoutes.employeecheckin, page: () => EmployeeCheckinScreen()),
    GetPage(name: AppRoutes.employeelate, page: () => EmployeeLateScreen()),
    GetPage(name: AppRoutes.employeeleavesummary, page: () => EmployeeLeaveSummaryScreen()),
    GetPage(name: AppRoutes.employeeabsent, page: () => EmployeeAbsentScreen()),
    GetPage(name: AppRoutes.employeeot, page: () => EmployeeOTScreen()),
    GetPage(name: AppRoutes.employeeprofile, page: () => EmployeeProfileScreen()),
