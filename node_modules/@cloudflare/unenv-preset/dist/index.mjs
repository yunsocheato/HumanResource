...
function getClusterOverrides({
  ...
  const enabledByFlag = compatibilityFlags.includes("enable_nodejs_cluster_module") && compatibilityFlags.includes("experimental");
  const enabled = enabledByFlag && !disabledByFlag;
  return enabled ? {
...
function getTraceEventsOverrides({
  ...
  const enabledByFlag = compatibilityFlags.includes("enable_nodejs_trace_events_module") && compatibilityFlags.includes("experimental");
  const enabled = enabledByFlag && !disabledByFlag;
  return enabled ? {
